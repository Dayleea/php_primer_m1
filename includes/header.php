...
<div class="container">
    ...
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link" href="arrays.php">Simple Array and Printouts</a></li>
        <li class="nav-item"><a class="nav-link" href="forloop.php">Simple For Loop</a></li>
        <li class="nav-item"><a class="nav-link" href="whilendowhileloop.php">Simple  While/Do While Loop</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="datentimemanipulation.php">Simple Date and Time Manipulation</a></li>
